...
# (list) iOS preinstall plugins to add
...
# (list) Put these files or directories in the apk libs/armeabi directory
#android.add_libs_armeabi = libs/android/*.so
#android.addlibs_armeabi_v7a = libs/android-v7/*.so
#android.add_libs_arm64_v8a = libs/android-v8/*.so
#android.add_libs_x86 = libs/android-x86/*.so
#android.add_libs_mips = libs/android-mips/*.so
...
# (str) python-for-android git clone directory (if empty, it will be automatically downloaded from github)
#p4a.source_dir =
